        ...
        <table class="w-full text-sm">
            <thead>
                <tr class="border-b border-gray-100 bg-[#F59E0B]">
                    <th class="px-5 py-3 text-center text-[11px] font-semibold text-[#162040] uppercase tracking-wide">
                        Nama Sekolah &amp; Alamat
                    </th>
                    <th class="px-5 py-3 text-center text-[11px] font-semibold text-[#162040] uppercase tracking-wide w-[150px]">
                        NPSN
                    </th>
                    <th class="px-5 py-3 text-center text-[11px] font-semibold text-[#162040] uppercase tracking-wide w-[110px]">
                        Jenjang
                    </th>
                    <th class="px-5 py-3 text-center text-[11px] font-semibold text-[#162040] uppercase tracking-wide w-[190px]">
                        Akreditasi
                    </th>
            ...
            <tbody class="divide-y divide-gray-50">
                @foreach($sekolahList as $sekolah)
                    ...
                    <tr class="hover:bg-gray-50/70 transition-colors">
                        ...
                        {{-- Jenjang --}}
                        <td class="px-5 py-4 align-middle text-center">
                            <span class="inline-flex items-center justify-center min-w-[44px] px-2.5 py-1 rounded-md text-xs font-bold {{ $badgeConfig['bg'] }} {{ $badgeConfig['text'] }}">
                                {{ $sekolah->jenjang ?: '-' }}
                            </span>
                        </td>
